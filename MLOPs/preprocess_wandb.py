...
# wandb.init(project="embedding_generation")
...
def run_embedding_generation(wandb_project: str, wandb_entity: str, data_path: str, dest_path: str):
    ...
    artifact = wandb.Artifact("Quora-sim", type="preprocessed_dataset")
